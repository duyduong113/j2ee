...
<html>
    ...
    <body class="skin-black">
        <%
            ...
            listUsers = usersDAO.getListUserByGroupIDNav(AllConstant.Group_MOD, keyword, (pages - 1) * AllConstant.Paging_record_Admin, AllConstant.Paging_record_Admin);
            total = usersDAO.countUsersByGroupIDNav(AllConstant.Group_MOD, keyword);
                            ...
                            <section class="panel general">
                                <header class="panel-heading tab-bg-dark-navy-blue">
                                    <ul class="nav nav-tabs">
                                        <li class="active">
                                            <a data-toggle="tab" href="#users-tab1">Danh sách người dùng</a>
                                        </li>
                                        <li>
                                            <a data-toggle="tab" href="#users-tab2">Thôn tin người dùng</a>
                                        </li>
                                    </ul>
                                </header>
                                <div class="panel-body">
                                    <div class="tab-content">
                                        <div id="users-tab1" class="tab-pane active">
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <div class="panel">         
                                                                ...
                                                                <tr id="table-middle">
                                                                    ...
                                                                    <td>
                                                                        <%
                                                                            if (users.isStatus()) {
                                                                        %>
                                                                        <a href="${root}/UsersManageServlet?command=changestatus&Status=<%=users.isStatus() ? false : true%>&ID=<%=users.getID()%>&keyword=<%=keyword%>&pages=<%=pages%>" class="btn btn-success"><%=users.isStatus() ? AllConstant.Status_True : AllConstant.Status_False%></a>
                                                                        <%  } else {
                                                                        %>
                                                                        <a href="${root}/UsersManageServlet?command=changestatus&Status=<%=users.isStatus() ? false : true%>&ID=<%=users.getID()%>&keyword=<%=keyword%>&pages=<%=pages%>" class="btn btn-danger"><%=users.isStatus() ? AllConstant.Status_True : AllConstant.Status_False%></a>
                                                                        <%}%>
                                                                    </td>
                                                                </tr>
                                                                <%
                                                            ...
                                                            <div class="pagination pagination-sm">
                                                                <ul class="pagination">
                                                                    <%
                                                                        if (keyword.equals("")) {
                                                                    %>
                                                                    <li><a href="${root}/administrator/users.jsp?pages=<%=pages == 1 ? pages : pages - 1%>">«</a></li>
                                                                        <%
                                                                        ...
                                                                        %>
                                                                    <li><a id="number<%=i%>" href="${root}/administrator/users.jsp?pages=<%=i%>"><%=i%></a></li>
                                                                        <%
                                                                            }
                                                                        %>
                                                                    <li><a href="${root}/administrator/users.jsp?pages=<%=pages == ((total % AllConstant.Paging_record_Admin == 0) ? (total / AllConstant.Paging_record_Admin) : (total / AllConstant.Paging_record_Admin + 1)) ? pages : pages + 1%>">»</a></li>
                                                                        <%
                                                                        } else {
                                                                        %>
                                                                    <li><a href="${root}/administrator/users.jsp?keyword=<%=keyword%>&pages=<%=pages == 1 ? pages : pages - 1%>">«</a></li>
                                                                        <%
                                                                            for (int i = 1; i <= (total % AllConstant.Paging_record_Admin != 0 ? total / AllConstant.Paging_record_Admin + 1 : total / AllConstant.Paging_record_Admin); i++) {
                                                                        %>
                                                                    <li><a id="number<%=i%>" href="${root}/administrator/users.jsp?keyword=<%=keyword%>&pages=<%=i%>"><%=i%></a></li>
                                                                        <%
                                                                            }
                                                                        %>
                                                                    <li><a href="${root}/administrator/users.jsp?keyword=<%=keyword%>&pages=<%=pages == (total / AllConstant.Paging_record_Admin + 1) ? pages : pages + 1%>">»</a></li>
                                                                        <%
                                                                            }
                                                                        %>
                                                                </ul>
                                        ...
                                        <div id="users-tab2" class="tab-pane">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <section class="panel">
